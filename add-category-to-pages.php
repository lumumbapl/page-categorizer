...
function acp_register_taxonomies() {
    register_taxonomy_for_object_type('post_tag', 'page');
    register_taxonomy_for_object_type('category', 'page');
}
add_action('init', 'acp_register_taxonomies');

function acp_modify_archive_query($wp_query) {
...
add_action('pre_get_posts', 'acp_modify_archive_query');
?>
